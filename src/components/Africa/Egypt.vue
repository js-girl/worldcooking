<template>
  ...
  <div id="zentai" v-show="showContent">
    ...
    <div id="gohan">
      <div class="content">
        <div class="title">フムス</div>
        <div class="kuni">エジプト</div>
      </div>
    </div>
    <div id="gazou">
      <div class="content">
    ...
    <div id="story">
      ...
      <div class="content">
        ...
        <div class="setumei">
          伝統的なアラブ料理であるフムスは、パレスチナ、レバノン、ヨルダン、シリア、イラク、エジプトなど中東の広い地域で食べられている。日本でも2004年現在、一般的な料理とはなっていないので、呼び名は混乱しており、ホンモス、フンムス、フムス、ハモスなど様々な名称で呼ばれている。
        </div>
      </div>
    </div>
    ...
    <div id="omise">
      <div class="content">
        ...
        <div class="mb-10">
          <a
            href="https://www.google.co.jp/maps/search/%E3%82%A8%E3%82%B8%E3%83%97%E3%83%88%E6%96%99%E7%90%86/@35.68,139.76,11.17z?authuser=0"
