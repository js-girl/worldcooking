  ...
  <div id="zentai" v-show="showContent">
    ...
    <div id="gazou">
      <div class="content">
        ...
        <img src="../../images/afternoontea.jpg" width="280px" />
      </div>
    </div>
    ...
    <div id="story">
      ...
      <div class="content">
        ...
        <div class="setumei">
          紅茶と共に軽食や菓子を摂る習慣。紅茶のほかに、キュウリのサンドイッチなどの軽食や、スコーン、ケーキ類といった菓子が供され、皿に盛った軽食・菓子が2
          -
          3段重ねのティースタンド（トレイの一種）に載せられる。1840年頃に第7代ベッドフォード公爵フランシス・ラッセルの夫人、アンナ・マリア・ラッセルによって始められたとされる。
        </div>
      </div>
    </div>
    ...
    <div id="omise">
      <div class="content">
        ...
        <div class="mb-10">
          <a
            href="https://restaurant.ikyu.com/rsSpcl/sp/afternoon/start.htm"
