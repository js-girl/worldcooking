...
export default {
  ...
  methods: {
    getrestaurant: function () {
      fetch(
        "https://thawing-dawn-38623.herokuapp.com/https://webservice.recruit.co.jp/hotpepper/gourmet/v1/?key=703a952c5ae9eaa7&large_area=Z011&genre=G006&format=json"
      )
        .then((res) => {
          return res.json()
        })
