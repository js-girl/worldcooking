  ...
  <div id="zentai" v-show="showContent">
    ...
    <div id="gohan">
      <div class="content">
        ...
        <div class="kuni">韓国</div>
      </div>
    </div>
    <div id="gazou">
      <div class="content">
        <!-- 画像を変更。imagesフォルダに追加してください。 -->
        <img src="../../images/kimuchi.jpg" width="280px" />
      </div>
    </div>
    ...
    <div id="story">
      ...
      <div class="content">
        ...
        <div class="setumei">
          儒教の陰陽五行思想に基づき五味（甘、辛、酸、苦、塩）、五食（赤、青、黄、白、黒）、五法（焼く、煮る、蒸す、炒める、生）をバランスよく取り入れることをよしとしている。唐辛子が伝来する前は、キムチには山椒が用いられていた。
        </div>
      </div>
    </div>
    ...
    <div id="omise">
      <div class="content">
        ...
        <div class="mb-10">
          <a
            href="https://www.google.co.jp/maps/search/%E9%9F%93%E5%9B%BD%E6%96%99%E7%90%86/@35.68,139.76,11z/data=!3m1!4b1?authuser=0"
