<template>
  ...
  <div id="zentai" v-show="showContent">
    ...
    <div id="gohan">
      <div class="content">
        <div class="title">魯肉飯</div>
        <div class="kuni">台湾</div>
      </div>
    </div>
    <div id="gazou">
      <div class="content">
        <!-- 画像を変更。imagesフォルダに追加してください。 -->
        <img src="../../images/Rurohan.jpg" width="280px" />
      </div>
    </div>
    ...
    <div id="omise">
      <div class="content">
        ...
        <div class="mb-10">
          <a
            href="https://www.google.co.jp/maps/search/%E5%8F%B0%E6%B9%BE%E6%96%99%E7%90%86/@35.68,139.76,11z/data=!3m1!4b1?authuser=0"
